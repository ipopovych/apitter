...
def userdict(data, param='name'):
    ...
    "protected"                    - bool info whether account is protected or not
    ...
    "geo_enabled"                  - bool info whether geolocation is enabled or not
    "verified"                     - bool info whether profile is verified or not
    "statuses_count"               - number of user's tweets
    "lang"                         - user's profile language
    "contributors_enabled"         - indicates that the user has an account with “contributor mode”
    enabled, allowing for Tweets issued by the user to be co-authored by another account.
    "is_translator"                - bool info whether translator is enabled or not
    "is_translation_enabled"       - bool info whether translation is enabled or not
    ...
    "profile_background_image_url_https" - https link to profile background image
    "profile_background_tile"      - bool info whether translation is enabled or not
    ...
    "profile_use_background_image" - bool info whether profile uses background image or not
    "has_extended_profile"         - bool info whether profile has extended profile or not
    "default_profile"              - bool info whether it is a default profile or not
    "default_profile_image"        - bool info whether profile image is default or not
    -----------------------------------------------------------------
    ...
    try:
        if param in userdict_params:
            ...
            d = {u['id']: {p: u[p] for p in userdict_params} for u in data['users']}
        else:
...
def relationdict(data, param='following'):
    ...
    "muting"              - bool info whether authorized user had muted specified or not
    "following"           - bool info whether authorized user is following specified or not
    "live_following"      - bool info whether authorized user is live following specified or not
    "follow_request_sent" - bool info whether authorized user had sent follow request to specified or not
    "notifications"       - bool info whether authorized user enabled notifications from specified or not
    "blocking"            - bool info whether authorized user had blocked specified or not
    "blocked_by"          - bool info whether authorized user is blocked by specified or not
    ...
    try:
        if param in relationdict_params:
            ...
            d = {u['id']: {p: u[p] for p in relationdict_params} for u in data['users']}
        else:
            print("Invalid param argument")
            return None
        return d
